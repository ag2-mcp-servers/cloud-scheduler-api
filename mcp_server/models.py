...
class PubsubMessage(BaseModel):
    ...
    orderingKey: Optional[str] = Field(
        None,
...
class RetryConfig(BaseModel):
    maxBackoffDuration: Optional[str] = Field(
        None,
    ...
    minBackoffDuration: Optional[str] = Field(
        None,
...
class RunJobRequest(BaseModel):
    legacyAppEngineCron: Optional[bool] = Field(
        None,
        description='This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job in the __cron queue with the corresponding name will be forced to run instead.',
    )
...
class AppEngineHttpTarget(BaseModel):
    appEngineRouting: Optional[AppEngineRouting] = Field(
        None, description='App Engine Routing setting for the job.'
    )
...
class HttpTarget(BaseModel):
    ...
    httpMethod: Optional[HttpMethod] = Field(
        None, description='Which HTTP method to use for the request.'
    )
...
class Job(BaseModel):
    appEngineHttpTarget: Optional[AppEngineHttpTarget] = Field(
        None, description='App Engine HTTP target.'
    )
    attemptDeadline: Optional[str] = Field(
        None,
    ...
    httpTarget: Optional[HttpTarget] = Field(None, description='HTTP target.')
    lastAttemptTime: Optional[str] = Field(
        None, description='Output only. The time the last job attempt started.'
    )
    legacyAppEngineCron: Optional[bool] = Field(
        None,
    ...
    pubsubTarget: Optional[PubsubTarget] = Field(None, description='Pub/Sub target.')
    retryConfig: Optional[RetryConfig] = Field(
        None, description='Settings that determine the retry behavior.'
    )
    ...
    state: Optional[State] = Field(None, description='Output only. State of the job.')
    ...
    userUpdateTime: Optional[str] = Field(
        None, description='Output only. The creation time of the job.'
    )
